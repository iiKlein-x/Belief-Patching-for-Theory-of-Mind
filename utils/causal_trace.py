...
def get_chat_offset(model_name):
...
def find_token_range(tokenizer, token_array, substring,allow_lowercase=True,find_sub_range=False,return_individual_pos = False,include_chat_template = False,  model_name=''):
    """
