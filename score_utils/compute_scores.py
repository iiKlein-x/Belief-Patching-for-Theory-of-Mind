...
def compute_relative_importance(score_dict,data_dict,tokenizer,metric = 'diff_prob'):
    ...
    if all_answer_pos[0] is None or answer_pos[0] is None:
...
def main():
    ...
    parser.add_argument('--model_name',type=str,default = 'gemma2-2B-chat')
    ...
    parser.add_argument('--dataset_name',type=str,default= ['csqa'],nargs='+')
                ...
                if metric == 'causal':
                    ...
                    for causal_type in args.causal_type:
                        ...
                        for sample_id,(ans_score,expl_score) in scores.items():
                            ...
                            if ans_importance[0] is None or expl_importance[0] is None:
                                continue
